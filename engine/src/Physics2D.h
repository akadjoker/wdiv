...
const int MAX_VERTICES = 24;
const int CIRCLE_VERTICES = 24;
const int COLLISION_ITERATIONS = 20;
...
public:
    ...
    // Joints (preparação para futuro)
    // void createDistanceJoint(Body* a, Body* b, float distance);
    // void createRevoluteJoint(Body* a, Body* b, const Vec2& anchor);
